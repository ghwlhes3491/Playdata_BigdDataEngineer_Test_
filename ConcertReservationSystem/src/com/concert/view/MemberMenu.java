...
public class MemberMenu {
	...
	public ReservationService Book = new ReservationService();
		...
		default:
			...
			System.out.println("메인 화면으로 되돌아 갑니다.");
			mainMenu();
	...
	private void serviceMainMenu() {
		...
		System.out.println("1. 공연정보 조회 및 예약");
		System.out.println("2. 공연예약확인");
		System.out.println("3. 공연예약취소");
...
//		Book.initReservation();
		...
		switch(concertNo) {
			case 1:
				//Book.ReservationService(Book.getBook01());
				Book.showReserve();
				break;
			case 2:
				//Book.ReservationService(Book.getBook02());
				Book.showReserve();
				break;
			case 3:
				//Book.ReservationService(Book.getBook01());
