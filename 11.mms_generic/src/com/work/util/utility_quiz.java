...
public class utility_quiz {
		public static void main(String[] args) {
//			System.out.println("현재날짜");
			print("현재날짜");
			System.out.println(utility_quiz.getCurrentDate());
			System.out.println(utility_quiz.getCurrentDate("MM-dd-yyyy"));
			System.out.println(utility_quiz.getCurrentDate("MM/dd/yyyy [a] hh:mm"));
			System.out.println(utility_quiz.getCurrentDate("MM/dd/yyyy [a] hh:mm", Locale.US));
			System.out.println(utility_quiz.getCurrentDate("MM/dd/yyyy [a] hh:mm", Locale.CHINA));
			System.out.println(utility_quiz.getCurrentDate("HH:mm"));
			System.out.println(utility_quiz.getCurrentDate("[a]hh:mm"));
			System.out.println(utility_quiz.getCurrentDate("[a]hh:mm", Locale.US));
